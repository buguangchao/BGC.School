...
namespace BGC.School.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,EnrollDate")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EnrollDate")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
